...
cp "${source_dir}/dense_baseline_summary.md" "${dest_reports}/"
cp "${source_dir}/dense_baseline_summary.json" "${dest_reports}/"
mkdir -p "${dest_reports}/external_eval"
cp "${source_dir}/external_eval/summary.md" "${dest_reports}/external_eval/"
cp "${source_dir}/external_eval/summary.json" "${dest_reports}/external_eval/"
